...
export default class Provider extends AbstractProvider {
    ...
    getLabel(result) {
        ...
        return [
            (_a = 
            // Building + Street
            result.locale_names) === null || _a === void 0 ? void 0 : _a.default[this.findBestMatchLevelIndex(result._highlightResult.locale_names.default)],
            (_b = 
            // City
            result.city) === null || _b === void 0 ? void 0 : _b.default[this.findBestMatchLevelIndex(result._highlightResult.city.default)],
            ...
            result.postcode) === null || _c === void 0 ? void 0 : _c[this.findBestMatchLevelIndex(result._highlightResult.postcode)],
            (_d = 
            // Country
            result.country) === null || _d === void 0 ? void 0 : _d.default,
        ]
            .filter(Boolean)
            .join(', ');
    }
